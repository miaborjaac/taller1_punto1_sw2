...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { kind: @drink.kind, name: @drink.name, price: @drink.price, size: @drink.size, trademark: @drink.trademark } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { kind: @drink.kind, name: @drink.name, price: @drink.price, size: @drink.size, trademark: @drink.trademark } }
