...
class SnacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snack" do
    assert_difference('Snack.count') do
      post snacks_url, params: { snack: { name: @snack.name, price: @snack.price, trademark: @snack.trademark } }
    end
  ...
  test "should update snack" do
    patch snack_url(@snack), params: { snack: { name: @snack.name, price: @snack.price, trademark: @snack.trademark } }
